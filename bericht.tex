...
\newcommand{\BetreuerDHBW}{Stefan Lehmann}

\newcommand{\Was}{Studienarbeit}

\newcommand{\Titel}{Bau eines voll funktionsfähiges, individuell angepasstem E-Bike}
...
\include{input/einleitung}
\include{input/batterie}
\include{input/motor}
\include{input/Controller}
\include{input/steuergerät}
\include{input/Schaltung}
\include{input/Konstruktion}
\include{input/Fazit}
